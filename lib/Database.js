...
class Database {
  ...
  async getPostCount() {
    const [ rows ] = await this.mysqlPool.execute('SELECT COUNT(*) AS count FROM posts');
  ...
  async getProjectCount() {
    const [ rows ] = await this.mysqlPool.execute('SELECT COUNT(*) AS count FROM projects');
  ...
  async getGallery() {
    const [ rows ] = await this.mysqlPool.execute('SELECT * FROM gallery');
