...
export default function SettingsOverlay() {
  ...
  return (
    <>
      <div className={`bg-slate-300 dark:bg-gray-900 fixed bottom-20 left-4 p-3 rounded-md shadow-lg hidden flex-col`} ref={settingsPanelRef}>
      ...
      <button className={`transition bg-slate-300 hover:bg-teal-700 focus:bg-teal-700 dark:bg-gray-900 focus:outline outline-teal-700/70 outline-offset-2 outline-2 p-3 rounded-full shadow-lg fixed bottom-4 left-4`} ref={settingsButtonRef} onClick={onSettingsButtonClick}>
